...
var API_TEMPLATE = "api_template-1.html"/*tpa=http://code.google.com/chrome/extensions/dev/js/template/api_template.html*/;
var SCHEMA = "extension_api-1.json.htm"/*tpa=http://code.google.com/chrome/extensions/dev/api/extension_api.json*/;
var DEVTOOLS_SCHEMA = "devtools_api-1.json.htm"/*tpa=http://code.google.com/chrome/extensions/dev/api/devtools_api.json*/;
var USE_DEVTOOLS_SCHEMA =
  /\.devtools[^/]*\.html/.test(location.pathname);
var API_MODULE_PREFIX = "chrome.";
var SAMPLES = "samples-1.json.htm"/*tpa=http://code.google.com/chrome/extensions/dev/js/samples.json*/;
